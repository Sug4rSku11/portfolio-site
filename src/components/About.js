    ...
    return (
        <div className='about-container'>
            <div className='home-a'>
                ...
                <p className='about'>Frontend: HTML, CSS, JavaScript, ReactJS, NPM,
                     Redux, Hooks, Context API, Jest, Cypress, Axios</p>
                <p className='about'>Backend: Node.js, Express, SQL, SQLite3, PostgreSQL,
                    Python, Git CLI, GitHub, VS Code , Vercel, Heroku, Netlify</p>
                <p className='about'>Additional Skills: Architecture, Debugging, Deployment</p>
            </div>
        </div>
